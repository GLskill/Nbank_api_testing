...
def test_user_make_deposit_by_ui(browser_context, config, page_objects, new_user):
    ...
    DialogHelper.assert_dialog_contains_text(dialog_info, "Successfully deposited")
    ...
    assert deposited_account["accountNumber"] == created_acc_number, "Account number should match"
